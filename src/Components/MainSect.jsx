...
{/* 
<div className="h-fit flex-col bg-[#0E0F22] flex items-center justify-center">
  <div className="grid text-white mt-10 md:grid-cols-3 lg:grid-rows-3 lg:w-[70%] w-full auto-rows-[300px]  gap-4">
   ...
   */}
{/* <div className=" md:w-[60vw] w-full h-[50vh] md:h-[70vh] rounded-4xl overflow-hidden absolute top-96 md:top-1/2 md:-translate-y-1/2 left-1/2 -translate-x-1/2">
<img
  className="hero-img  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
  src="tech.jpg"
  alt=""
  srcset=""
/>
...
*/}
{/* <div id="zoom">
  <div className="w-full bg-[#0E0F22] flex items-center justify-center">
  ...
  <div className="w-full bg-[#0E0F22] flex items-center justify-center">
    <div className="flex-center flex-col min-h-dvh p-5 relative radial-gradient">
      <div className="md:w-[60vw] w-full h-[50vh] md:h-[70vh] rounded-4xl overflow-hidden absolute top-0 md:top-1/2 md:-translate-y-1/2 left-1/2 -translate-x-1/2">
        <div className="w-full">
          <img
            className="hero-img size-full object-contain"
            src="tech.jpg"
            alt=""
            srcset=""
          />
...
{/* <div>
<img className="hero-img" src="tech.jpg" alt="" srcset="" />
</div> */}